...
INSERT INTO `tab_lotes` (`id_lote`,  `entrada`, `vencimento`) VALUES
(1,  '2022-08-20', '2023-08-20'),
(2,  '2022-08-20', '2023-09-20'),
(3,  '2022-08-20', '2022-10-20'),
(4,  '2022-08-01', '2022-10-20');
...
INSERT INTO `tab_produtos` (`id_produto`,`id_fornecedor`, `nome`, `preco`, `imagem`, `descricao`, `tamanho`, `unidademedida`, `id_categoria`, `id_animal`, `id_marca`, `id_lote`,`quantidade`) VALUES
(1,1, 'Magnus todo dia', '121.90', 'imagem.jpg', 'A ração Magnus Todo Dia de 15 kg e 25 kg é de qualidade premium e tem sabor especial de carne. Além disso, a comidinha não contém adição de corantes e possui um complexo de ingredientes que promovem mais saúde e bem-estar aos cães.\r\nPorte da Raça: Peso do Cão (kg)\r\nGigante: Acima de 40\r\nGrande: 25 - 40', 0, 15, 1, 1, 1, 1,3),
(2,1, 'Whiskas sache', '2.99', 'imagem.jpg', ' Feito com ingredientes naturais de alta qualidade, vitaminas e minerais; - Sem conservantes, sem corantes artificiais e sem aromatizantes artificiais. A Ração Úmida Whiskas Sachê Carne ao Molho para Gatos Adultos Castrados oferece pedaços médio de peixe ao molho, mega delicioso ao paladar do seu gatinho.', 0, 85, 1, 2, 3, 4,2),
(3,1, 'Ração Premium Flakes Nutricon', '20.99', 'Ração Premium Flakes Nutricon.jpg', ' Premium Flakes é um alimento completo, em flocos, indicado para todas as espécies de peixes ornamentais tropicais em fase de crescimento ou manutenção. Ideal para aquários comunitários. Formulado à base de ingredientes de alta qualidade e digestibilidade.', 0, 50, 1, 3, 4, 3,10);
