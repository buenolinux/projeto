...
--
-- Host: localhost
-- Tempo de geração: 22-Ago-2022 às 04:36
...
--
-- Banco de dados: `lojavirtual_COM_AUTO_INCREMENTO`
--
CREATE DATABASE IF NOT EXISTS `lojavirtual_COM_AUTO_INCREMENTO` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `lojavirtual_COM_AUTO_INCREMENTO`;
...
--
-- AUTO_INCREMENT de tabela `tab_itens_pedidos`
--
ALTER TABLE `tab_itens_pedidos`
